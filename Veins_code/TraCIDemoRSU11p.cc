...
void TraCIDemoRSU11p::onWSM(BaseFrame1609_4* frame)
{
    ...
    EV << "I am an RSU and have received a WSM so will increase the counter from " << counter << " to " << counter +1 << std::endl;
    counter++;


    if (counter ==2 && sentMessage == false) { //send message to vehicles on road a saying to slow down
