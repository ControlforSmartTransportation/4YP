...
#include <veins/modules/application/traci/SmartJunctionCarApp_stop_modified.h>
...
using namespace std;
Define_Module(veins::SmartJunctionCarApp_stop_modified);




void SmartJunctionCarApp_stop_modified::initialize(int stage)
{
...
void SmartJunctionCarApp_stop_modified::finish()
{
    DemoBaseApplLayer::finish();
    // statistics recording goes here
}

void SmartJunctionCarApp_stop_modified::onBSM(DemoSafetyMessage* bsm)
{
...
void SmartJunctionCarApp_stop_modified::onWSM(BaseFrame1609_4* frame)
{
    ...
    if (stopCheck == false) {
        ...
        } //else if (strcmp(wsm->getDemoData(),"all roads apart from bottom road stop") == 0 && (mobility->getRoadId() != "right_in_main" && mobility->getRoadId() != "right_in" )) {
            //EV << "I am right road so will slow"  << std::endl;
           // traciVehicle->setMaxSpeed(traciVehicle->getMaxSpeed()/2);
           // traciVehicle->setSpeed(0);
           // stopCheck = true;
       // } //else if (strcmp(wsm->getDemoData(),"all roads apart from bottom road stop") == 0 && (mobility->getRoadId() != "top_in_main" && mobility->getRoadId() != "top_in" )) {
...
void SmartJunctionCarApp_stop_modified::onWSA(DemoServiceAdvertisment* wsa)
{
    // Your application has received a service advertisement from another car or RSU
    // code for handling the message goes here, see TraciDemo11p.cc for examples
}

void SmartJunctionCarApp_stop_modified::handleSelfMsg(cMessage* msg)
{
...
void SmartJunctionCarApp_stop_modified::handlePositionUpdate(cObject* obj)
{
