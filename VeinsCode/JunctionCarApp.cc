...
#include <veins/modules/application/traci/JunctionCarApp.h>
...
using namespace std;
Define_Module(veins::JunctionCarApp);




void JunctionCarApp::initialize(int stage)
{
...
void JunctionCarApp::finish()
{
    DemoBaseApplLayer::finish();
    // statistics recording goes here
}

void JunctionCarApp::onBSM(DemoSafetyMessage* bsm)
{
    ...
    if (mobility->getRoadId() == "right_in") {
...
/**
    } else if (mobility->getRoadId() == "bottom_in") {    //condition for if vehicle is on a certain road
    ...
    } else if (mobility->getRoadId() == "left_in") {
...
void JunctionCarApp::onWSM(BaseFrame1609_4* frame)
{
...
void JunctionCarApp::onWSA(DemoServiceAdvertisment* wsa)
{
    // Your application has received a service advertisement from another car or RSU
    // code for handling the message goes here, see TraciDemo11p.cc for examples
}

void JunctionCarApp::handleSelfMsg(cMessage* msg)
{
...
void JunctionCarApp::handlePositionUpdate(cObject* obj)
{
