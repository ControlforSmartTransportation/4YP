...
#include <veins/modules/application/traci/ParallelRSUApp2.h>
#include "veins/modules/application/traci/TraCIDemo11pMessage_m.h"

using namespace veins;

Define_Module(veins::ParallelRSUApp2);

void ParallelRSUApp2::onWSA(DemoServiceAdvertisment* wsa)
{
...
void ParallelRSUApp2::onWSM(BaseFrame1609_4* frame)
{
...
void ParallelRSUApp2::handleSelfMsg(cMessage* msg)
{
    switch (msg->getKind()) {
