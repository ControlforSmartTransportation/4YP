...
#include <veins/modules/application/traci/ParallelCarApp2.h>
...
using namespace std;
Define_Module(veins::ParallelCarApp2);




void ParallelCarApp2::initialize(int stage)
{
...
void ParallelCarApp2::finish()
{
    DemoBaseApplLayer::finish();
    // statistics recording goes here
}

void ParallelCarApp2::onBSM(DemoSafetyMessage* bsm)
{
...
void ParallelCarApp2::onWSM(BaseFrame1609_4* frame)
{
...
void ParallelCarApp2::onWSA(DemoServiceAdvertisment* wsa)
{
    // Your application has received a service advertisement from another car or RSU
    // code for handling the message goes here, see TraciDemo11p.cc for examples
}

void ParallelCarApp2::handleSelfMsg(cMessage* msg)
{
...
void ParallelCarApp2::handlePositionUpdate(cObject* obj)
{
